/** Promedios mensuales de Tarija, Bolivia. Usados para las proyecciones de crecimiento. */
export const TARIJA_BY_MONTH: Record<number, { temperature: number; humidity: number; lightHours: number }> = {
